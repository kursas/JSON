#add_JSON_data_into_sqlite3_db_table_in_python
import json
with open('D:/DUMENYS/DARIUS/Desktop/states2.json', 'r', encoding='utf-8') as f:
    text = json.load(f)
    f_list = text['states']
    #print(type(f_list))
    print(f_list)
...
#delete json item
with open('D:/DUMENYS/DARIUS/Desktop/states2.json') as f:
  data = json.load(f)
for state in data['states']:
  del state['area_codes']
with open('D:/DUMENYS/DARIUS/Desktop/new_states2.json', 'w') as f:
  json.dump(data, f, indent=2)

#creates an SQLite database file.
import sqlite3
#Connecting to sqlite
conn = sqlite3.connect('D:/DUMENYS/DARIUS/Desktop/example1.db')
...
#paklausti-kaip visus names and abbreviations ikelt i db?
for item in f_list:
    cursor.execute('INSERT INTO states (name, abbreviation) VALUES(:name,:abbreviation);',item)
